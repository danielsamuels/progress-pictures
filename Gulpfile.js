...
var staticFolder = 'progress/static/';
var templateFolder = 'progress/templates/';
...
gulp.task('bowerFiles', function() {
    gulp.src([
        ...
        .pipe(gulp.dest('progress/static/js/vendor/'));


    gulp.src('bower_components/foundation/js/foundation/*')
        .pipe(gulp.dest('progress/static/js/vendor/foundation/'));
    ...
    gulp.src([
        ...
        .pipe(gulp.dest('progress/static/scss/'));
